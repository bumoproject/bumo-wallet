...
export default {
  ...
  async getTokenBalance(params) {
    try {
      ...
      let options = {
        // uri: 'http://seed1.bumotest.io:26002/getAccountAssets',
        uri: `http://${conf.connections.http_host}:${conf.connections.http_port}/getAccountAssets`,
        qs: {
  ...
  async getTokenType() {
    try {
      ...
      //   return (commonUtil.packageError(constUtil.ERRORS.ERR_PARAMS));
      // }
      // let data = await historyRecord.getTokenType(
      //     params.pageStartIndex, params.pageSize);
      let data = await historyRecord.getTokenType();
      return (data);
    } catch (err) {
